...
// FIX: Rename XMarkIcon to CloseIcon to match usage in modals and components
...
export const AcademicCapIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0l-2.09-.648A59.904 59.904 0 0112 3.493a59.902 59.902 0 0110.399 5.84l-2.09.647m-15.482 0l15.482 0M12 10.147v10.757" />
    </svg>
);
...
export const CopyIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 8.25V6a2.25 2.25 0 00-2.25-2.25H6A2.25 2.25 0 003.75 6v8.25A2.25 2.25 0 006 16.5h2.25m8.25-8.25H18a2.25 2.25 0 012.25 2.25v8.25A2.25 2.25 0 0118 21H9.75A2.25 2.25 0 017.5 18.75v-2.25m0 0a2.25 2.25 0 002.25 2.25h6a2.25 2.25 0 002.25-2.25v-6a2.25 2.25 0 00-2.25-2.25H9.75a2.25 2.25 0 00-2.25 2.25m0 0v2.25" />
  </svg>
);

export const DeepThinkIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M17.5 11a3.5 3.5 0 0 0 -3.5 3.5v1.5a3.5 3.5 0 0 0 7 0v-1.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.5 11a3.5 3.5 0 0 1 3.5 3.5v1.5a3.5 3.5 0 0 1 -7 0v-1.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M16 4a5 5 0 0 0 -9.024 2.45c-1.472 .835 -2.476 2.33 -2.476 4.05v1" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M17 6.275c1.472 .835 2.476 2.33 2.476 4.05v1" />
  </svg>
);
...
export const SparklesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09ZM18.259 8.715 18 9.75l-.259-1.035a3.375 3.375 0 0 0-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 0 0 2.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 0 0 2.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 0 0-2.456 2.456ZM16.898 20.502 16.5 21.75l-.398-1.248a3.375 3.375 0 0 0-2.456-2.456L12.75 18l1.248-.398a3.375 3.375 0 0 0 2.456-2.456L16.5 14.25l.398 1.248a3.375 3.375 0 0 0 2.456 2.456L20.25 18l-1.248.398a3.375 3.375 0 0 0-2.456 2.456Z" />
  </svg>
);
...
export const PuzzlePieceIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 6.083a3.755 3.755 0 01-3.417 2.167h-1.583a3.755 3.755 0 01-3.417-2.167 3.75 3.75 0 010-4.333A3.755 3.755 0 015.833 3.75h1.583a3.755 3.755 0 013.417 2.167 3.75 3.75 0 010 4.333zM9.75 12h-1.5a2.25 2.25 0 00-2.25 2.25v1.5a2.25 2.25 0 002.25 2.25h1.5a2.25 2.25 0 002.25-2.25v-1.5a2.25 2.25 0 00-2.25-2.25zm6 0h-1.5a2.25 2.25 0 00-2.25 2.25v1.5a2.25 2.25 0 002.25 2.25h1.5a2.25 2.25 0 002.25-2.25v-1.5a2.25 2.25 0 00-2.25-2.25zM12 9.75a2.25 2.25 0 002.25-2.25v-1.5a2.25 2.25 0 00-2.25-2.25h-1.5a2.25 2.25 0 00-2.25 2.25v1.5a2.25 2.25 0 002.25 2.25h1.5z" />
  </svg>
);

export const WrenchScrewdriverIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 4.5l7.5 7.5-7.5 7.5-7.5-7.5 7.5-7.5zM11.25 10.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.923 21.365a15.42 15.42 0 003.846-2.122m-3.846 2.122a15.42 15.42 0 01-3.846-2.122m3.846 2.122v-3.375m-3.846 2.122l-1.423-1.423m5.269 1.423l1.423-1.423M3.75 9.75h16.5m-16.5 0a2.625 2.625 0 00-2.625 2.625v.001c0 1.45 1.175 2.625 2.625 2.625h16.5c1.45 0 2.625-1.175 2.625-2.625v-.001a2.625 2.625 0 00-2.625-2.625M3.75 9.75V6.375c0-1.036.84-1.875 1.875-1.875h12.75c1.035 0 1.875.84 1.875 1.875v3.375" />
    </svg>
);
...
export const UserGroupIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.57-1.023-.09-2.317-1.255-2.317h-2.502a2.25 2.25 0 01-2.25-2.25v-2.5c0-1.242.75-2.25 2.25-2.25h2.502a2.25 2.25 0 012.25 2.25v2.5a2.25 2.25 0 01-1.255 2.317m-7.5-2.962a2.25 2.25 0 00-2.25-2.25h-2.5c-1.5 0-2.25 1.008-2.25 2.25v2.5A2.25 2.25 0 004.5 16.5h2.5a2.25 2.25 0 002.25-2.25m-7.5-2.962V8.25a2.25 2.25 0 012.25-2.25h2.5a2.25 2.25 0 012.25 2.25v.938m-7.5 5.25a2.25 2.25 0 002.25 2.25h2.5a2.25 2.25 0 002.25-2.25" />
  </svg>
);
...
export const ForwardIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 4.5l7.5 7.5-7.5 7.5" />
  </svg>
);
...
export const BackwardIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 19.5L1.5 12l7.5-7.5" />
  </svg>
);
...
export const PaintBrushIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 0 0-5.78 1.128 2.25 2.25 0 0 1-2.4 2.245 4.5 4.5 0 0 0 8.4-2.245c0-.399-.078-.78-.22-1.128Zm0 0a15.998 15.998 0 0 0 3.388-1.62m-5.043-.025a15.998 15.998 0 0 1 1.622-3.385m5.043.025a15.998 15.998 0 0 0 1.622-3.385m3.388 1.62a15.998 15.998 0 0 0-1.62-3.385m0 0a4.5 4.5 0 0 0-6.364-6.364l-1.622 3.385a15.998 15.998 0 0 1-1.622 3.385m6.364 6.364a4.5 4.5 0 0 0 6.364 6.364l1.622-3.385a15.998 15.998 0 0 1 1.622-3.385" />
    </svg>
);
...
export const TypeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 4.5v15m12-15v15M3 4.5h18" />
    </svg>
);
...
export const ModelIcon = RobotIcon;
